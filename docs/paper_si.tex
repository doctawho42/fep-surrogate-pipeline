...
asserts on every run. That digest lives in the same repository as the file, so it detects
accidental drift and not backdating; we claim the former and not the latter. The file below governs

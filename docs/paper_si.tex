...
rather than corrected because correcting it would change the digest. Two labels in the frozen file
...
scaled by $\sqrt{h_e}$), and it attributes the conserved budget to Theorem~\ref{thm:hodge} where
the conservation law is Theorem~\ref{thm:cons}; it also cites a part ``5(i')'' that does not exist,
the intended reference being part (i) of Theorem~\ref{thm:hodge}. The file below governs

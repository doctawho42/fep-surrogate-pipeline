...
in a further sense: we are aware of no deployed or published relative-binding-free-energy pipeline
that feeds a learned per-edge $\sigma$ into a network consistency check, so what the contrast
measures is what would happen if one did. Applying instead the learned head's

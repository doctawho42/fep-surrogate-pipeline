...
and an anti-conservative tail can coexist. The correction is applied across systems, which are
fitted separately and share no edges, so the independence Benjamini--Hochberg needs is plausible
between them even though residuals within a system are dependent by construction; The nominal level is reported as nominal. The case for

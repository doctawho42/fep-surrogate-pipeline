...
proved and verified against finite differences but not exercised by any experiment here, and as the
conductance of a measurement graph. The knowledge gradient is exactly zero along every
gauge-redundant direction of that graph, which follows from the Laplacian's kernel and so holds for
any positive conductances rather than from the sandwich weighting.
\end{itemize}
...
left to this paper is that reading for alchemical networks, part (iv), which prices the escape in
measurements rather than leaving it qualitative, and above all the measurement of where a real

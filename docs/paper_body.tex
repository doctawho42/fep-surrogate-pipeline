...
closure statistic uses, carries under one per cent of the error against experiment, still a factor
of $1.36$ below chance at the weakest reading tried. The test is correspondingly
narrow: its flags sit inside the field's fixed $1.0$ kcal/mol hysteresis cutoff on every replicate
and remove $20$ of its $26$ on the first, removing the edges it names does not recover accuracy against
experiment, and widening every reported error by half, enough to cover the pose and preparation

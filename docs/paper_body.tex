...
self-calibrated arm holding its level ($0.003$ against a nominal $0.05$) and so the conservative
answer (Supplementary Table~\ref{tab:selfgrid}).
...
$\mathbb{E}[\chi^2_\nu]$ of Section~\ref{sec:oos}. Across it the flag count runs from six to nine.
...
flags anything when nothing is wrong is $0.000$ at $0.79$, $0.003$ at $0.92$, $0.045$ at $1.00$ and
$0.100$ at $1.04$ (seeded, $400$ draws, released with the analysis code; the value at $c=1$ is the
quantity the uncorrected arm of Supplementary Table~\ref{tab:selfgrid} reports as $0.040$ by a
different path, the two agreeing within Monte-Carlo error at this draw count). That simulation verifies the Benjamini--Hochberg implementation rather than the

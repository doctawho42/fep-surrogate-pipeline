...
narrow: on the first replicate its flags sit inside the field's fixed $1.0$ kcal/mol hysteresis
cutoff and remove $20$ of its $26$, removing the edges it names does not recover accuracy against
...
nothing. Nor are the two rules independent: on this benchmark the flag sets are strictly nested,
the calibrated null flagging $6$ systems, the fixed-$\mathrm{se}$ test $11$ and the $1.0$ kcal/mol
cutoff $26$, so the calibrated null catches nothing the field's cutoff misses and instead removes
$20$ of its flags. Whether that removal is an improvement is what the contaminated label cannot
...
advantage claimed here is structural, being per-edge adaptive thresholds, a null tied to
replicate-measured calibration, and the observability map. It does not deliver a repair list: removing the edges it names does not recover accuracy against

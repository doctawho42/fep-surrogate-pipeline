...
between them even though residuals within a system are dependent by construction; the procedure
also holds under positive regression dependence, which is the direction any residual between-system
coupling would take. The nominal level is reported as nominal. The case for
...
the per-ligand systematic error part (i) is about and resolves none of it, while a measured anchor
resolves its dimension only to its own precision. By part (iv) the arithmetic is unforgiving even
...
least one false flag among them at $1-0.96^3=0.115$ if they were independent, which they are not.
